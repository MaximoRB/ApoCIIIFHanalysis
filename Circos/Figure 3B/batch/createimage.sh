...
$PERL $CIRCOS_DIR/bin/circos -param random_string=lnfmjff -conf etc/circos.conf
cd WORKING_DIR; PERL CIRCOS_DIR/bin/circos -param random_string=lnfmjff -conf WORKING_DIR/etc/circos.conf 2>&1 > WORKING_DIR/results/report.txt
tar cvfz circos-tableviewer-lnfmjff.tar.gz *
